        ...
        <div className="mx-auto max-w-6xl relative z-10">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold tracking-tight">
              <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent leading-tight">
                Hub
              </span>
            </h2>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mb-10 sm:mb-14 max-w-4xl mx-auto px-4 sm:px-0">
            <div className="flex items-center gap-3 p-3 sm:p-4 rounded-xl shadow-lg backdrop-blur-md transition-all duration-300 border w-full sm:w-auto bg-white/70 border-gray-200/30 hover:bg-white/80">
              <div className="p-2 rounded-lg bg-violet-100">
                <svg className="h-4 sm:h-5 w-4 sm:w-5 text-violet-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3 p-3 sm:p-4 rounded-xl shadow-lg backdrop-blur-md transition-all duration-300 border w-full sm:w-auto bg-white/70 border-gray-200/30 hover:bg-white/80">
              <div className="p-2 rounded-lg bg-pink-100">
                <svg className="h-4 sm:h-5 w-4 sm:w-5 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4 sm:px-0">
            <button
              ...
              className="cursor-pointer gap-2 px-4 sm:px-8 py-3 text-sm sm:text-base font-medium shadow-lg transition-all duration-300 flex-1 sm:flex-none bg-slate-950 hover:bg-slate-900 text-white rounded-lg"
            >
            ...
            <button
              ...
              className="cursor-pointer gap-2 px-4 sm:px-8 py-3 text-sm sm:text-base font-medium shadow-lg transition-all duration-300 flex-1 sm:flex-none bg-white text-black hover:bg-gray-100 rounded-lg border border-gray-200"
            >
              <svg className="h-4 sm:h-5 w-4 sm:w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
